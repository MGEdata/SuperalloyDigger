...
from table_info_html import GetTInfoFromHtml
...
class AllCase:
    ...
    def case_3(self, html_path, journal, out_path_txt, out_path, m_path):
        oj = OtherJ()
        get_table = GetTInfoFromHtml(html_path, self.table_save_path)
        get_table.run()
        html_p = HtmlParser(journal, html_path, out_path_txt)
