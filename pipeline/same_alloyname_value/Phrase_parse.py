        ...
        for word in word_list:
            ...
            for q in range(0, len_type):
                if outcome_filter[q]:
                    ...
                    break
        re_sub_order = copy.deepcopy(sub_order)
        for word in sub_order:
            if word in object_list:
                re_sub_order.remove(word)
        # print(re_sub_order, sub_id, object_list)
        return re_sub_order, sub_id, object_list
